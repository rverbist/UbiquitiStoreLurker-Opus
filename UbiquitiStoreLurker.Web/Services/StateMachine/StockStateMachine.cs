...
namespace UbiquitiStoreLurker.Web.Services.StateMachine;
    ...
    ILogger<StockStateMachine> logger)
{
    public TransitionResult Evaluate(
        ...
        StockCheck check)
    {
        using var activity = UbiquitiStoreLurkerActivities.Source.StartActivity("state.evaluate", ActivityKind.Internal);
