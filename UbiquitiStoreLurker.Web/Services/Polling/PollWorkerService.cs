    ...
    : BackgroundService
{
    ...
    {
        using var activity = UbiquitiStoreLurkerActivities.Source.StartActivity("poll.execute", ActivityKind.Internal);
        ...
        try
        {
            ...
            var client = httpClientFactory.CreateClient("UbiquitiStoreLurkerPoller");
            ...
            UbiquitiStoreLurkerMetrics.StockChecksTotal.WithLabels("success").Inc();
            UbiquitiStoreLurkerMetrics.PollDurationSeconds.Observe(sw.Elapsed.TotalSeconds);
        ...
        catch (Exception ex) when (ex is not OperationCanceledException)
        {
            ...
            UbiquitiStoreLurkerMetrics.StockChecksTotal.WithLabels("error").Inc();
        ...
        if (product is not null)
        {
            ...
            if (parseResult is not null)
            {
                ...
                if (transitionResult.StateChanged && transitionResult.Transition is not null)
                {
                    ...
                    UbiquitiStoreLurkerMetrics.StockTransitionsTotal
