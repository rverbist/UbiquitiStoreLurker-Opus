    ...
    ILogger<NotificationDispatcher> logger)
{
    ...
    {
        using var activity = UbiquitiStoreLurkerActivities.Source.StartActivity("notification.dispatch", ActivityKind.Internal);
        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            sw.Stop();
            UbiquitiStoreLurkerMetrics.NotificationLatencySeconds.Observe(sw.Elapsed.TotalSeconds);
            UbiquitiStoreLurkerMetrics.NotificationsSentTotal
