...
namespace UbiquitiStoreLurker.Tests;
...
/// The entry point calls db.Database.MigrateAsync() against /data/ubiquitistorelurker.db which
...
public sealed class TestApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        builder.ConfigureHostConfiguration(config =>
        {
            ...
            {
                ["ConnectionStrings:ubiquitistorelurker-db"] = _connectionString,
            });
        });
